  ...
  <div class="space-y-8">
    <div class="text-center">
      ...
      <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
        A full-stack starter template with Vue 3, Nuxt 3, Supabase, Tailwind CSS, Pinia, and
        TypeScript. Built for scalability and developer experience.
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <p class="text-gray-600 dark:text-gray-300">
          Secure user authentication with Supabase Auth, including email/password and OAuth
          providers.
        </p>
      </div>
